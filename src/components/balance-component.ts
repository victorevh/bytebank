...
if (dateAcessElement !== null) {
    dateAcessElement.textContent = dateFormat(UserAccount.getAcessDate(), DateFormat.DAY_WEEK_DAY_MONTH_YEAR)
}
...
export function renderBalance(): void {
    if (balanceElement !== null) {
        balanceElement.textContent = coinFormat(UserAccount.getBalance());
    }
}
